...
class ConfigProvider extends ConfigProviderAbstract
{
    ...
    const DD_ENABLED = 'enabled';
    const DD_REQUIRED = 'date_required';
    const AVAILABLE_DAYS = 'available_days';
    const AVAILABLE_HOURS = 'available_hours';
    const COMMENT_ENABLED = 'delivery_comment_enable';
    const COMMENT_DEFAULT = 'delivery_comment_default';

    const XPATH_FIRST_DAY = 'general/locale/firstday';
