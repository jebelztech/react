...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Satish_Manage::Forms')
            ->addBreadcrumb(__('Satish Manage'), __('Satish Manage'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Satish\Manage\Model\Forms');
        ...
        $this->_coreRegistry->register('forms', $model);

        // 5. Build edit form
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->_initAction();
        $resultPage->setActiveMenu('Satish_Manage::forms');
        $resultPage->addBreadcrumb(__('Satish'), __('Satish'));
