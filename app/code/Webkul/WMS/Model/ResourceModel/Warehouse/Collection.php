...
namespace Webkul\WMS\Model\ResourceModel\Warehouse;

use Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection;

/**
 * Class Collection warehouse
 *
 * @author   Webkul <support@webkul.com>
 * @license  https://store.webkul.com/license.html ASL Licence
 * @link     https://store.webkul.com/license.html
...
class Collection extends AbstractCollection
{
    ...
    {
        $this->_init(
            \Webkul\WMS\Model\Warehouse::class,
            \Webkul\WMS\Model\ResourceModel\Warehouse::class
        );
        $this->_map["fields"]["id"] = "main_table.id";
    }

    /**
     * Filter warehouse by store
     *
     ...
     * @return boolean
     */
    public function setWarehouseData($condition, $attributeData)
    {
        return $this->getConnection()->update(
            $this->getTable("wms_warehouse"),
            $attributeData,
            $where = $condition
        );
    }
