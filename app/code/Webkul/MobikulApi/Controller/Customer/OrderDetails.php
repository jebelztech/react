...
class OrderDetails extends AbstractCustomer
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            if($this->customerId == ''){
            $this->returnArray["customerName"] = $this->loadedOrder->getCustomerPrefix()." ".$this->loadedOrder->getCustomerFirstname()." ".
                $this->loadedOrder->getCustomerLastname();
            $this->returnArray["customerEmail"] = $this->loadedOrder->getCustomerEmail();
            }else{
