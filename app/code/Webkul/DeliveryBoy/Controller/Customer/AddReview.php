    ...
    public function execute()
    {
        ...
        try {
            if ($request->getMethod() === "POST" && $request->isXmlHttpRequest() &&
                ...
                $deliveryBoyId = $this->escaper->escapeHtmlAttr($request->getParam('deliveryBoyId') ?? null);
                $customerId = $this->escaper->escapeHtmlAttr($request->getParam('customerId') ?? null);
                $title = $this->escaper->escapeHtmlAttr($request->getParam('title') ?? null);
                $rating = $this->escaper->escapeHtmlAttr($request->getParam('rating') ?? null);
                $comment = $this->escaper->escapeHtmlAttr($request->getParam('comment') ?? null);
