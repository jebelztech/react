        ...
        $fieldset->addField(
		  ...
		  $fieldset->addField(
            ...
            [
                'name' => 'vendor_address',
                'data-form-part' => $this->getData('target_form'),
                'label' => __('Pick Up Address'),
                'title' => __('Pick Up Address'),
                'value' => $partner['vendor_address'],
            ]
        );
		  ...
		  $fieldset->addField(
            ...
            [
                ...
                'value' => $partner['bank_account_name'],
            ]
        );
		 ...
		 $fieldset->addField(
            ...
            [
                ...
                'data-form-part' => $this->getData('target_form'),
                'label' => __('Bank Branch number'),
                'title' => __('Bank Branch number'),
                'value' => $partner['bank_branch_number'],
            ]
        );
            ...
            [
                ...
                'title' => __('Bank account IBAN'),
                'value' => $partner['bank_account_iban'],
            ]
        );
            ...
            [
                ...
                'title' => __('Bank SWIFT code'),
                'value' => $partner['bank_swift_code'],
            ]
        );
            ...
            [
                'name' => 'trade_license',
                'data-form-part' => $this->getData('target_form'),
                'label' => __('trade_license'),
                'title' => __('trade_license'),
                'value' => $partner['trade_license'],
                'after_element_html' => '<a href="'.$mediaUrl.$partner['trade_license'].'" download>'.$partner['trade_license'].'</a>',
            ]
        );
            ...
            [
                ...
                'data-form-part' => $this->getData('target_form'),
                'label' => __('vat_certificate'),
                'title' => __('vat_certificate'),
                'value' => $partner['vat_certificate'],
                'after_element_html' => '
                <a href="'.$mediaUrl.$partner['vat_certificate'].'"
                >'.$partner['vat_certificate'].'</a>',
            ]
        );
